...
LOCAL_SRC_FILES := ./opencv/native/libs/armeabi-v7a/libopencv_core.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE    := opencv_imgproc
LOCAL_SRC_FILES := ./opencv/native/libs/armeabi-v7a/libopencv_imgproc.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE    := opencv_highgui
LOCAL_SRC_FILES := ./opencv/native/libs/armeabi-v7a/libopencv_highgui.a
include $(PREBUILT_STATIC_LIBRARY)
include $(CLEAR_VARS) 
